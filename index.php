...
<html lang="en">
    ...
    <body>
		...
		<!-- START HOME -->
		<section id="home" class="hero" style="background-image: url(assets/img/bg/slide3.jpg);  background-size:cover; background-position: center center;background-attachment:fixed;">
